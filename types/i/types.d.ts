...
export interface Extends {
  'plugin:i/recommended': void;
  'plugin:i/errors': void;
  'plugin:i/warnings': void;
  'plugin:i/stage-0': void;
  'plugin:i/react': void;
  'plugin:i/react-native': void;
  'plugin:i/electron': void;
  'plugin:i/typescript': void;
}
...
export interface RuleOptions {
   ...
   */
  'i/no-restricted-paths': NoRestrictedPathsRuleOptions;
  /**
   ...
   */
  'i/no-relative-packages': NoRelativePackagesRuleOptions;
  /**
   ...
   */
  'i/no-relative-parent-imports': NoRelativeParentImportsRuleOptions;
  /**
   ...
   */
  'i/no-named-as-default': NoNamedAsDefaultRuleOptions;
  /**
   ...
   */
  'i/no-named-as-default-member': NoNamedAsDefaultMemberRuleOptions;
  /**
   ...
   */
  'i/no-anonymous-default-export': NoAnonymousDefaultExportRuleOptions;
  /**
   ...
   */
  'i/max-dependencies': MaxDependenciesRuleOptions;
  /**
   ...
   */
  'i/no-extraneous-dependencies': NoExtraneousDependenciesRuleOptions;
  /**
   ...
   */
  'i/newline-after-import': NewlineAfterImportRuleOptions;
  /**
   ...
   */
  'i/no-unassigned-import': NoUnassignedImportRuleOptions;
  /**
   ...
   */
  'i/no-useless-path-segments': NoUselessPathSegmentsRuleOptions;
  /**
   ...
   */
  'i/dynamic-import-chunkname': DynamicImportChunknameRuleOptions;
  /**
   * Forbid import statements with CommonJS module.exports.
   *
   * @see [no-import-module-exports](undefined)
   */
  'i/no-import-module-exports': NoImportModuleExportsRuleOptions;
  /**
   ...
   */
  'i/imports-first': ImportsFirstRuleOptions;
}
